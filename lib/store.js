...
var storeConfig = {
    ...
    actionsCreators: {
        initStore: function (state, actions, sPWebUrl, currentListId, currentMode, currentItemId) { return __awaiter(_this, void 0, void 0, function () {
            var _a, list, listFields, toSelect, toExpand, _i, listFields_1, f, fieldInfos, eTag, itemMetadata, item, attachmentMetadata, _b, listFields_2, fm, _c, _d, _e, listFields_3, fm, _f, _g;
            return __generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 3:
                        ...
                        _h.label = 4;
                    case 4:
                        if (!(_b < listFields_2.length)) return [3, 7];
                        fm = listFields_2[_b];
                    ...
                    case 8:
                        ...
                        _h.label = 9;
                    case 9:
                        if (!(_e < listFields_3.length)) return [3, 12];
                        fm = listFields_3[_e];
