...
var storeConfig = {
    ...
    actionsCreators: {
        initStore: function (state, actions, sPWebUrl, currentListId, currentMode, currentItemId) { return __awaiter(_this, void 0, void 0, function () {
            var list, listFields, toSelect, toExpand, _i, listFields_1, f, fieldInfos, eTag, itemMetadata, item, attachmentMetadata, _a, listFields_2, fm, _b, _c, _d, listFields_3, fm, _e, _f, _g;
            return __generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 1:
                        ...
                        fieldInfos = [];
                        eTag = '*';
                        if (!(currentMode !== FormMode.New)) return [3, 8];
                        itemMetadata = list.items.getById(currentItemId);
                        return [4, (_g = itemMetadata.select.apply(itemMetadata, toSelect)).expand.apply(_g, toExpand).get()];
                    case 2:
                        item = _h.sent();
                    ...
                    case 3:
                        ...
                        console.log(item);
                        _a = 0, listFields_2 = listFields;
                        _h.label = 4;
                    case 4:
                        if (!(_a < listFields_2.length)) return [3, 7];
                        fm = listFields_2[_a];
                        _c = (_b = fieldInfos).push;
                    ...
                    case 7:
                        ...
                        return [3, 12];
                    case 8:
                        _d = 0, listFields_3 = listFields;
                        _h.label = 9;
                    case 9:
                        if (!(_d < listFields_3.length)) return [3, 12];
                        fm = listFields_3[_d];
                        _f = (_e = fieldInfos).push;
...
var saveFormData = function () { return __awaiter(_this, void 0, void 0, function () {
    var toResolve, globalState_1, formDataRegularFields, itemCollection, action, currentEtag, currentItemId, initialAdding, res, errors, attachmentProps_1, attachments, list, addMultipleResult, attachmentData, e_1, e_2, _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                toResolve = {};
