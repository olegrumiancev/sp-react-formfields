...
var FieldUserRenderer = (function (_super) {
    ...
    FieldUserRenderer.prototype.renderNewOrEditForm = function () {
        ...
        return (React.createElement("div", null,
            React.createElement(NormalPeoplePicker, { itemLimit: this.props.IsMulti ? undefined : 1, defaultSelectedItems: this.state.currentSelectedItems, onResolveSuggestions: this.onFilterChanged, getTextFromItem: this.getTextFromItem, pickerSuggestionsProps: { searchingText: 'Searching more..' }, className: 'ms-PeoplePicker', key: this.props.InternalName + "_normalpicker", onRemoveSuggestion: this.onRemoveSuggestion, onValidateInput: this.validateInput, removeButtonAriaLabel: 'Remove', onChange: this.onItemsChange, searchingText: 'Searching...', inputProps: {
                    placeholder: 'Enter a name or email address'
                }, resolveDelay: 300, componentRef: function (p) { _this.pp = p; } })));
    };
