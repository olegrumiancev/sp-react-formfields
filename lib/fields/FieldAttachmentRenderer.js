...
var FieldAttachmentRenderer = (function (_super) {
    ...
    function FieldAttachmentRenderer(props) {
        ...
        _this.onNewFileRemoved = function (file) {
        ...
        _this.onExistingFileDeleteClick = function (ev) {
            ...
            _this.setState({ existingToDelete: globalState.ExistingAttachmentsToDelete });
        };
        _this.onDrop = function (ev) {
            console.log(ev);
        };
        _this.state = __assign({}, _this.state, { currentValue: props.FormFieldValue, existingToDelete: props.ExistingAttachmentsToDelete === undefined ? [] : props.ExistingAttachmentsToDelete });
        return _this;
    }
