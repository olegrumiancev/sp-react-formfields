...
var FieldLookupRenderer = (function (_super) {
    ...
    function FieldLookupRenderer(props) {
        ...
        _this.state = __assign({}, _this.state, { selectedItems: vals.reduce(function (prevResult, v) {
                if (v.Id && v.Id > 0) {
                    prevResult.push({ key: v.Id, name: v[_this.props.LookupField] });
                }
                return prevResult;
            }, []), allLookupItems: null });
        return _this;
    ...
    FieldLookupRenderer.prototype.renderNewOrEditForm = function () {
        ...
        return (React.createElement(TagPicker, { className: 'lookupTagPickerInput', itemLimit: this.props.IsMulti ? 100 : 1, pickerSuggestionsProps: {
            ...
            }, onResolveSuggestions: function (filter, selectedItems) { return _this.resolveTagSuggestions(filter, selectedItems); }, defaultSelectedItems: this.state.selectedItems, onChange: function (items) { return _this.processTagItemsChange(items == null ? [] : items); }, resolveDelay: 750, ref: function (c) {
                if (c != null) {
                    _this.tagPicker = c;
                }
            } }));
