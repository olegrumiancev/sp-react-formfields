...
var ListForm = (function (_super) {
    ...
    ListForm.prototype.render = function () {
        ...
        var ListFormStateless = FormFieldsStore.connect(function (state) {
            var enhancedState = __assign({}, state, { getButtonsByFormMode: _this.getButtonsByFormMode });
    ...
    return React.createElement("div", null,
        ...
        props.IsLoading ?
            ...
            React.createElement(React.Fragment, null,
                ...
                props.Fields.map(function (f) { return (React.createElement("div", { className: 'formRow', key: "formRow_" + f.InternalName },
