...
var ListForm = (function (_super) {
    ...
    ListForm.prototype.render = function () {
        ...
        var ListFormStateless = FormFieldsStore.connect(function (state) {
            var enhancedState = __assign({}, state, { closeForm: _this.closeForm, getButtonsByFormMode: _this.getButtonsByFormMode });
    ...
    ListForm.prototype.closeForm = function () {
    };
...
export var ListFormInternal = function (props) {
    return React.createElement("div", null,
        ...
        props.IsLoading ?
            ...
            React.createElement(React.Fragment, null, props.Fields.map(function (f) { return (React.createElement("div", { className: 'formRow', key: "formRow_" + f.InternalName },
